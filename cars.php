...
<html lang="en">
	...
	<body>
		...
		<h1>Cars</h1>
		<div style="float:left;width:300px" id="container">
			<div id="leftContainer" hspace="150" vspace="20">
				<img src="img/car.png" align="left"/>
			</div>
			<div id="rightContainer" hspace="150" vspace="20">
				<p class="description"> VIN: <br> Make: <br> Model: <br> Year: </p>
			</div>
		</div>		
		<div class="container">
